...
/// High-level client for syncing a local directory with a remote storage backend.
///
/// Backend-agnostic: takes any [StorageAdapter] (Drive, S3, Box, ...) and
/// orchestrates the full sync cycle including local manifest persistence.
///
/// ```dart
...
class SyncClient {
  ...
  /// Sync local directory with the remote storage root.
