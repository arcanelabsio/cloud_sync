/// OAuth scope modes supported by [DriveAdapter].
///
...
/// [DriveAdapter.userDrive] (which needs full `drive` scope) but the
/// auth client was obtained with `drive.file` only. The first Drive API
/// call — usually [DriveAdapter.ensureFolder] — returns a 403 and is
/// re-raised as this error with a clear remediation message.
